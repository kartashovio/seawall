...
// is already covered by the panels below (the wall, the "why these limits" panel),
// so we don't repeat a "current state" banner there — only the contract-only freeze
// warrants a top-of-page alarm.
export function PostureBanner({ paused }: { paused: boolean }) {
  if (!paused) return null;
  return (
    <div className="posture is-frozen" role="status">
